...
To solve this issue, we propose a new paradigm: _Continuous Organizations_ (CO), a new type of organization designed to align the  stakeholders' interests significantly better than in traditional organizations. A _Continuous Organization_ is any kind of organization that issues fully digital securities called _FAIR_[^2]_ Securities_ by funneling part or all of its cash-flows to a _Decentralized Autonomous Trust_ (_DAT_). A _DAT_ is a smart-contract that automatically mints, burns and distributes _FAIR Securities_ (_FAIRs_) according to the organization cash-flows and predefined rules.
...
<p id="gdcalert1" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Context"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Context](#heading=h.84h4c591zibu)

    1.1 

<p id="gdcalert2" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Organizations have evolved to adapt to the digital economy"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert3">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Organizations have evolved to adapt to the digital economy](#heading=h.pe68rlusjp8)

    1.2 

<p id="gdcalert3" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "The rise of the multitude"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert4">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[The rise of the multitude](#heading=h.2k19xnp54f7e)

    1.3 

<p id="gdcalert4" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "New challenges"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert5">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[New challenges](#heading=h.z38ky415f1po)

    1.4 

<p id="gdcalert5" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "ICOs: a first (insufficient) answer to a real challenge"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert6">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[ICOs: a first (insufficient) answer to a real challenge](#heading=h.rg6yc0jn9qiw)

2. 

<p id="gdcalert6" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Continuous Organizations"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert7">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Continuous Organizations](#heading=h.q3j10a5c71j6)

    2.1 

<p id="gdcalert7" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Understanding the token bonding curve model"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert8">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Understanding the token bonding curve model](#heading=h.dcbdybgb3z5v)

    2.2 

<p id="gdcalert8" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "The Decentralized Autonomous Trust"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert9">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[The Decentralized Autonomous Trust](#heading=h.s4u1btjvoihg)

    2.3 

<p id="gdcalert9" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Properties and incentives of a Continuous Organization"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert10">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Properties and incentives of a Continuous Organization](#heading=h.4vh8ara4wm49)

3. 

<p id="gdcalert10" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Benefits"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert11">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Benefits](#heading=h.rpkk6jhnge3u)

4. 

<p id="gdcalert11" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Use cases"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert12">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Use cases](#heading=h.3m1nrxwem7ll)

5. 

<p id="gdcalert12" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Legal & Regulatory considerations"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert13">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Legal & Regulatory considerations](#heading=h.m786tclubm6o)

6. 

<p id="gdcalert13" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Attack vectors"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert14">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Attack vectors](#heading=h.m786tclubm6o)

    6.1 

<p id="gdcalert14" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Front-running attack"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert15">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Front-running attack](#heading=h.sfpwv07pw105)

7. 

<p id="gdcalert15" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "Conclusion"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert16">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

[Conclusion](#heading=h.alvelqufsv8e)

<h3>Context</h3>


<h4>Organizations have evolved to adapt to the digital economy</h4>
...
To define the nature of this power, Nicolas Colin defined the concept of _multitude_ in a previous book co-authored with Henri Verdier[^8]:
...
**Long term wealth building & social security**. When a community (be they users, workers, partners, suppliers, customers...) fall in love with the product or service provided by an organization, they wish they could have the possibility to be financially rewarded for their active contributions to the product and build long term wealth as they help the organization grow. One-off referrals, coupons, goodies can only do so much… people want money! This is especially true in today's context where well-paid jobs with social security and 401Ks are becoming the exception[^11].
...
**Innovators attraction. Investors protection. Taxes.** Regulators (usually) aim at providing innovators with a regulatory framework that help them create new services and products. One the key aspect of such a regulatory framework is to help innovators raise capital while giving investors reasonable legal protections against malconducts. Before the digital economy, this strategy would yield big returns through tax collection. Unfortunately for the regulators, the digital economy has made tax collection much more difficult. Indeed:
    ...
    _«The digital economy systematically disconnects the place of business from the place of consumption. Consequently, it is increasingly difficult to fix the location of the value created by this economy and to apply the rules of tax laws that are now outmoded_[^13]_.»_
...
**Long-term energy efficient organizations**. Creating incentive mechanisms that could lead to organizations to optimizing for the long-term while keeping them accountable for their environmental impact would be highly beneficial for humanity as a whole. As of today, our inability to establish a global enforceable governance on environmental topics and the short-termism of today's financial markets, has made the Tragedy of the Commons all too real[^14]. 

<h4>ICOs: a first (insufficient) answer to a real challenge</h4>
...
*   **Founders** raise a lot of money without giving any governance rights[^15], allowing them to pursue their vision. Thanks to the tokens they generated, they can create many financial incentives that are beneficial to the organization, from recruiting talents to enabling network effects that have the potential to grow their community exponentially.
...
The problem is that it is very hard for the unsophisticated investor[^16] to assess whether tokens will have any value at all. As a result, many retail investors, lured by the exceptional returns of a handful of well thought-out projects, burned themselves very badly.
...
Given the above, it is expected that most projects will fail and are bad investments[^17][^18]. Even worse: a project can be very successful yet his token have no value. This creates two important problems:



1.  **Retail investors get scammed** due the way the _Shitcoin Waterfall_ works in ICOs[^19].


1.  **Regulators don't know how to regulate ICOs**. On the one hand, they welcome innovations that attract talents and investors but on the other hand, they don't like when retail investors get scammed.
...
It is sad to see that many ICOs actually on the market are scams. In the best case scenario, they are promoted by well intentioned founders who mistook an ICO for a Series A fundraising. In the worst case scenario, these ICOs are simply engineered by scammers trying to abuse unsophisticated investors to get rich quick. Needless to say that, in this context, it is hard not to see the ICO market for utility tokens dying[^20].
