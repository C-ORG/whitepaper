...
It goes without saying that the "security" nature of _FAIR Securities_ (FAIR Securities undeniably pass the [Howey test](https://en.wikipedia.org/wiki/SEC_v._W._J._Howey_Co.)) requires the issuer to comply with the securities laws of the juridisdiction it is operting in.
