...
Even though it is not mandatory, it is highly recommended to have a vesting schedule for the _FAIRs_ that are pre-minted in order to commit their beneficiaries over the long term and help them resist the temptation to sell at the first opportunity.
